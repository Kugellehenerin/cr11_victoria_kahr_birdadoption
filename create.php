...
<fieldset >
   ...
   <form  action="actions/a_create.php" method= "post">
       <table cellspacing= "0" cellpadding="0">
           ...
           <tr>
               <th>Name</th>
               <td><input  type="text" name= "bird_name" placeholder="Name"/></td>
           </tr>
           <tr>
               <th>Age</th>
               <td><input type="text"  name="bird_age" placeholder ="Age"/></td>
           </tr>
           <tr>
               <th>Description</th>
               <td><input type="text"  name="bird_description" placeholder ="Description"/></td>
           </tr>
           <tr>
               <td><button type ="submit">Insert Bird</button></td>
